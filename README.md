...
- AI 复核可按自然语言要求定位字段、指定列和具体内容，并在本机校验建议能否实际改变当前文件。
- Excel 支持用“F列脱敏”“脱敏F列”直接指定目标列；能够在本机确定目标时，不等待 AI 返回。
...
当前版本：**v1.3.0**，支持 Windows 10/11 x64。

[下载 v1.3.0 Windows 便携版](https://github.com/Brand1on/ai-desensitizer-showcase/releases/tag/v1.3.0)
...
```text
F52AD329A739075E7DC81EF9D6C09E4F93083E5B9C6D32FC43CA32E18E7FC4FD
```
...
- AI 复核检查当前脱敏结果，单位名称、部门、业务组分别判断，不再互相顶替。
- 复核结果不再限制为 8 条；关注项优先显示，选中建议按实际命中数量应用。
